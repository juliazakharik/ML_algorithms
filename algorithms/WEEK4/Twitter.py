...
class Twitter(object):
    ...
    def postTweet(self, userId, tweetId):
        ...
        :rtype: None
        """
        self.tweets_users[tweetId] = userId
    ...
    def getNewsFeed(self, userId):
        ...
        elif userId not in self.followees[userId]:
            self.followees[userId].append(userId)
        for tweetId in self.feed[::-1]:
            if i == 10:
                return res
            if self.tweets_users[tweetId] in self.followees[userId]:
                res.append(tweetId)
                i += 1
        return res
